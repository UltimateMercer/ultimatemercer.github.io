  ...
  return (
    <aside className="flex flex-col sticky lg:h-[calc(100vh-65px)] h-[calc(100vh-56px)] lg:top-[57px] top-[48px] w-1/6 p-2.5 bg-custom-brown dark:bg-[#252525] border-b border-[#121212] dark:border-custom-brown rounded-2xl">
      <nav className="space-y-1 border border-[#121212] dark:border-custom-brown rounded-lg p-2">
        <div className="px-4 py-2 rounded-t-md bg-[#252525] dark:bg-custom-brown border-b border-[#252525] dark:border-custom-brown">
        ...
        {data.map((it, i) => {
          ...
          return (
            <Button
              key={i}
              variant="ghost"
              className={`w-full justify-start text-left py-2 px-4 h-auto rounded cursor-pointer hover:text-custom-brown-text hover:bg-[#252525] ${
                activeSection === id && "bg-[#252525] text-custom-brown-text "
